...
class UserRepository:
    ...
    async def get_user_by_id(self, conn: asyncpg.Connection, id: str):
        query = "SELECT id, email, full_name, role, email_verified, is_deleted, created_at FROM users WHERE id = $1"
    ...
    @with_connection
    async def mark_email_verified(self, conn: asyncpg.Connection, user_id: str):
